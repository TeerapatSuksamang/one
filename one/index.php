    ...
    <nav class="navbar navbar-expand-sm navbar-dark fixed-top" style="background: #252525a1; backdrop-filter: blur(5px);">
        <div class="container-fluid">
            <a href="index.php" class="pro-brand">
                <img src="img/จิปาถะ/favicon.png" class="img">
            </a>
            <a href="index.php" class="navbar-brand">web_name</a>
                        ...
                        <div class="row align-items-center h-100">
                            <div class="col-md-8 text-light">
                                ...
                                <h3>
                                    ...
                                    พร้อมโค้ดส่วนลดมื้อสุขสุดคุ้มอีกมากมาย
                                </h3>
                    ...
                    <div class="container h-100">
                        <div class="row align-items-center h-100">
                            <div class="col-md-8 text-light">
                                ...
                                <h3>เข้าถึงลูกค้าได้มากกว่า เพื่อเพิ่มยอดขายให้กับธุรกิจร้านอาหารของค</h3>
