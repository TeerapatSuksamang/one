            ...
            <div class="scroll mb-3">
                ...
                ?>
                    <div class="box text-center mx-2">
                        <a href="see_res_type.php?res_type=<?php echo $row_type['res_type'] ?>" class="link-img hover-img border shadow">
                            <img src="../upload/<?php echo  $row_type['img'] ?>" class="img">
                        </a>
                        <br>
                        <a href="see_res_type.php?res_type=<?php echo $row_type['res_type'] ?>" class="text-dark"><?php echo  $row_type['res_type'] ?></a>
                    </div>
                <?php } ?>
            </div>
            <hr>
